      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
            Your ultimate car management platform. Browse, add, and manage your car inventory with ease.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <Card className="text-center hover:shadow-lg transition-shadow">
            <CardHeader>
              ...
              <CardDescription>
                Easily add new cars to your inventory with detailed information
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button
          ...
          <Card className="text-center hover:shadow-lg transition-shadow">
            <CardHeader>
              ...
              <CardDescription>
                Read the latest news and reviews about cars and automotive industry
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button
